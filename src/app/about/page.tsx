...
export default function about() {
    return (
      <div>
        ...
        <Image src="\my pic.jpg" alt="" width="400" height="50" className="py-20 px-20  " />
          <div>
            <h1 className="text-center text-[50px] font-extrabold">Introduction</h1>
            <div className="text-xl font-bold text-center leading-tight">I am a Computer Science student at the University of the Karachi, pursuing ADS (Associate Degree in Science) in Computer Science. My passion lies in exploring the realms of Generative AI and large language models, combining my interest in AI with hands-on skills in Python, JavaScript, TypeScript, HTML, and CSS. Currently, I am diving into Next.js to expand my web development toolkit and further prepare for a future of creating innovative, tech-driven solutions.</div>
